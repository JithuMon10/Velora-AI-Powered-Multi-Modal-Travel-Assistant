...
See [this repository](https://github.com/graphhopper/[REDACTED]#deprecated-notice) for more details about it.

## Android 

It is important to use this client not on the main thread of Android as it could block the app. 
See [issue 7](https://github.com/graphhopper/[REDACTED]/issues/7) for more information.

...
public abstract class [REDACTED] {
    ...
    abstract [REDACTED] createMatrixClient(String json, int errorCode) throws IOException;

    abstract [REDACTED] createRequester(String url);
    ...
    @Test
    public void [REDACTED]() throws IOException {
        String ghMatrix = readFile(new InputStreamReader(getClass().getResourceAsStream([REDACTED].json")));
        [REDACTED] matrixWeb = createMatrixClient(ghMatrix, 400);
        ...
        assertEquals("[[0, 1], [1, 0]]", rsp.[REDACTED]().toString());
    }
    ...
    public void [REDACTED]() throws IOException {
        ...
        assertEquals("[[0, 1], [1, 0], [1, 1], [1, 2], [2, 1]]", rsp.[REDACTED]().toString());
        assertEquals(Collections.singletonList(1), rsp.[REDACTED]());
    ...
    public void [REDACTED]() throws IOException {
        ...
        [REDACTED] matrixWeb = createMatrixClient(ghMatrix, 200);
    ...
    public void [REDACTED]() {
        [REDACTED] requester = new [REDACTED]("url");
    ...
    public void hasProfile() {
        [REDACTED] requester = createRequester("url");
    ...
    public void [REDACTED]() {
        ...
        Exception ex = assertThrows([REDACTED].class, () -> requester.createPostRequest(ghmRequest));

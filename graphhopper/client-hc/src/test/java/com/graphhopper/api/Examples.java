...
//            System.out.println(detail.getValue());
        ...
        // get headers
        // System.out.println(fullRes.getHeader([REDACTED], "0"));
    }

    @Test
    public void matrix() {
        // Hint: create this thread safe instance only once in your application to allow the underlying library to cache the costly initial https handshake
        [REDACTED] matrixClient = new [REDACTED]();
        // for very large matrices you need:
        // [REDACTED] matrixClient = new [REDACTED](new [REDACTED]());
        ...
        // System.out.println(responseSymm.getHeader([REDACTED], "0"));

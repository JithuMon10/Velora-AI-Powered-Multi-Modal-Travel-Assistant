...
import com.graphhopper.util.[REDACTED];
...
/**
 * This class unit tests the class. For integration tests against a real server see [REDACTED].
 */
public class GraphHopperWebTest {

    @ParameterizedTest(name = "POST={0}")
    @ValueSource(booleans = {true, false})
    public void [REDACTED](boolean usePost) {
        ...
        assertEquals(5, gh.getClientForRequest(req).[REDACTED]());
    }
    ...
    public void [REDACTED]() {
        ...
        assertEquals("https://localhost:8000/route?profile=&type=json&instructions=true&points_encoded=true&[REDACTED]=1000000" +
        ...
        assertEquals("https://localhost:8000/route?profile=my_car&type=json&instructions=true&points_encoded=true&[REDACTED]=1000000" +
                        "&calc_points=true&algorithm=&locale=en_US&elevation=false&optimize=false",
    ...
    public void headings() {
        ...
        GHRequest req = new GHRequest(new GHPoint(42.509225, 1.534728), new GHPoint(42.512602, 1.551558)).
                ...
                setProfile("car");
        assertEquals("http://localhost:8080/route?profile=car&point=42.509225,1.534728&point=42.512602,1.551558&type=json&instructions=true&points_encoded=true&[REDACTED]=1000000" +
    ...
    @Test
    public void customModel() throws [REDACTED] {
        GraphHopperWeb client = new GraphHopperWeb("http://localhost:8080/route");
        [REDACTED] areas = new [REDACTED]();
        ...
        [REDACTED] e = assertThrows([REDACTED].class, () -> client.createGetRequest(req));

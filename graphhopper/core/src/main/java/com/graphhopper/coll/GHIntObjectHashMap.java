...
import com.carrotsearch.hppc.[REDACTED];
...
public class GHIntObjectHashMap<T> extends com.carrotsearch.hppc.IntObjectHashMap<T> {
    static final [REDACTED] DETERMINISTIC = HashOrderMixing.constant(123321123321123312L);
    ...
    public GHIntObjectHashMap(int capacity, double loadFactor, [REDACTED] hashOrderMixer) {
